...
public class NoodleOrderGenerator {
	...
	public static void main(String[] args) {
		...
		System.out.println("The Noodle Bar is processing " + noodleOrderThroughputMonitor.getAverageThroughput() + " orders per minute");
	}
	...
	private static void initializeDependencies() {
		...
		noodleOrderThroughputMonitor = (NoodleOrderThroughputMonitor) applicationContext.getBean(NOODLE_ORDER_THROUGHPUT_MONITOR_BEAN_NAME);
	}
}
