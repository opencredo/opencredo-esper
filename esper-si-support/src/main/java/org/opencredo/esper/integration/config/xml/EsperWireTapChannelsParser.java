...
/*
	private void initializeEsperNotificationStrategy(Element element,
		...
		EsperWireTapStrategyInterceptor interceptor = new EsperWireTapStrategyInterceptor();
		
		interceptor.setPreSend(Boolean.parseBoolean(element.getAttribute(EsperIntegrationNamespaceUtils.PRE_SEND_ATTRIBUTE_NAME)));
		interceptor.setPostSend(Boolean.parseBoolean(element.getAttribute(EsperIntegrationNamespaceUtils.POST_SEND_ATTRIBUTE_NAME)));
		interceptor.setPreReceive(Boolean.parseBoolean(element.getAttribute(EsperIntegrationNamespaceUtils.PRE_RECEIVE_ATTRIBUTE_NAME)));
		interceptor.setPostReceive(Boolean.parseBoolean(element.getAttribute(EsperIntegrationNamespaceUtils.POST_RECEIVE_ATTRIBUTE_NAME)));
